...
import com.example.limitlife.ui.screen.mainScreen.RouteUpdateNoteScreen
...
fun EditNoteScreen(
    ...
    onBackPressed : () -> Unit,
    onHeadingValueChange : (String) -> Unit,
        ...
        TopAppBar(
            title = {
                BasicTextField(
                    ...
                    onValueChange = onHeadingValueChange,
                    textStyle = TextStyle(
                        fontSize = 18.sp ,
            ...
            actions = { SaveButton { onSaveNoteClick() } },
            modifier = Modifier.background(MaterialTheme.colorScheme.secondaryContainer)
        )
        Text(text = serverResponse , modifier = Modifier.padding(vertical = 8.dp , horizontal = 8.dp ))
        CustomNoteTextField(
            modifier = modifier
                .fillMaxSize()
                .statusBarsPadding()
